...
<div class="icon">
      ...
      <a href="<?php echo base_url('Paymenthistory') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
...
<div class="col-lg-6 col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <i class="fa fa-briefcase"></i>
        <h3 class="box-title">Statistik <small>Payment History</small></h3>
      ...
      <div class="box-body">
        <canvas id="data-kota1" style="height:250px"></canvas>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  //data payment
  var pieChartCanvas = $("#data-payment").get(0).getContext("2d");
  var pieChart = new Chart(pieChartCanvas);
  var PieData = <?php echo $data_payment; ?>;
